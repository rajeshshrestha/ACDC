...
6. Download and put the ImageNet model in this directory [Pretrained Model Link](https://drive.google.com/drive/folders/1jElnRoFv7b31fG0v6pTSQkelbSX3xGZh) or use the following command   
